...
import com.dev.hopi_app.Adapter.OfflineAdapter;
...
public class AdminOfflineActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuery = new Firebase("https://hopiiapp.firebaseio.com/offline");

        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recycler_users);
        mMyAdapter = new OfflineAdapter(mQuery, Users.class, mAdapterItems, mAdapterKeys);
