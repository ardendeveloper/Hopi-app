...
import com.dev.hopi_app.Adapter.AuditTrailAdapter;
...
public class AdminAuditTrailActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    Query mQuery;
    AuditTrailAdapter mMyAdapter;
    ArrayList<AuditTrail> mAdapterItems = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mQuery = new Firebase("https://hopiiapp.firebaseio.com/audit-trail");

        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recycler_users);
        mMyAdapter = new AuditTrailAdapter(mQuery, AuditTrail.class, mAdapterItems, mAdapterKeys);
